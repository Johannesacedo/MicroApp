            ...
            <div class="card">
                <div class="card-header">Edit {{$todo->title}}</div>
                    <h5 class="card-header">
                         <a href="{{ route('todo.index') }}" class="btn btn-sm btn-outline-primary">
                ...
                @if ($errors->any())
                    ...
                    <form method="POST" action="{{ route('todo.update',$todo->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <textarea name="description" id="description" cols="30" rows="10" class="form-control @error('password') is-invalid @enderror" autocomplete="description" value="{{ $todo->description }}">
                            {{ $todo->description }}
                            </textarea>
